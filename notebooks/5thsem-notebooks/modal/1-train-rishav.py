...
app = modal.App("lerobot-rishav-training")
...
def train(
    ...
    train_cmd = [
        "lerobot-train",
        "--dataset.repo_id=Sri-Ram-A/touch2",
...
def main():
    train.remote(
        ...
        batch=16,
        policy="act",
        job_name="2-act_touch2",
    )

# https://wandb.ai/chandanamn-cs23-na/lerobot/runs/r3qsjku6
